<h1 align="center">yt_dlp_mod</h1>

<p align="center">
<a href="#"><img alt="Python version" src="https://img.shields.io/pypi/pyversions/yt-dlp-mod"/></a>
<a href="LICENSE"><img alt="License" src="https://img.shields.io/static/v1?logo=MIT&color=Blue&message=MIT&label=License"/></a>
<a href="https://pypi.org/project/yt-dlp-mod"><img alt="PyPi" src="https://img.shields.io/pypi/v/yt-dlp-mod"></a>
<a href="https://github.com/Simatwa/yt-dlp-mod/releases"><img src="https://img.shields.io/github/v/release/Simatwa/yt-dlp-mod?label=Release&logo=github" alt="Latest release"></img></a>
<a href="https://github.com/psf/black"><img alt="Black" src="https://img.shields.io/badge/code%20style-black-000000.svg"/></a>
<a href="https://pepy.tech/project/yt-dlp-mod"><img src="https://static.pepy.tech/personalized-badge/yt-dlp-mod?period=total&units=international_system&left_color=grey&right_color=blue&left_text=Downloads" alt="Downloads"></a>
<a href="https://hits.seeyoufarm.com"><img src="https://hits.seeyoufarm.com/api/count/incr/badge.svg?url=https%3A%2F%2Fgithub.com%2FIamDvis%2Fyt-dlp-mod"/></a>
</p>
...
```sh
pip install yt-dlp-mod -U
```

## Google Colab

You can use the [colab_script.md](colab_script.md) to quickly download videos/audio in Google Colab. Just copy the code and run!
...
Usage : `$ yt-dlpm video <VIDEO-URL>`

<details>

<summary>
<code>$ python -m yt_dlp_mod download-video --help</code>
</summary>

```
                                                                                
 Usage: python -m yt_dlp_mod download-video [OPTIONS] URL                     
...
Usage : `$ yt-dlpm audio <VIDEO-URL>`

<details>
<summary>
<code>$ python -m yt_dlp_mod download-audio --help</code>
</summary>

```
                                                                                
 Usage: python -m yt_dlp_mod download-audio [OPTIONS] URL                     
...
│ --format                   [webm|mp4|mp3|m4a]       Media format to process  │
│                                                     ie. mp4 or webm          │
│                                                     [default: webm]          │
...
<summary>
<code>$ python -m yt_dlp_mod --help</code>
</summary>

```
                                                                                
 Usage: python -m yt_dlp_mod [OPTIONS] COMMAND [ARGS]...                      
...
│ audio            Download audio version of a YouTube video                   │
╰──────────────────────────────────────────────────────────────────────────────╯
...
This project is an extension of [yt-dlp](https://github.com/yt-dlp/yt-dlp).
Original author: **[Simatwa Caleb](https://github.com/Simatwa)**.
Personalized by: **IamDvis**.
